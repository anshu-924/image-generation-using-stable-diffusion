    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-400 mb-4">
              Transforming your creative ideas into stunning clothing designs with AI technology.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#generator" className="text-gray-400 hover:text-white transition-colors duration-200">Generator</a></li>
              <li><a href="#examples" className="text-gray-400 hover:text-white transition-colors duration-200">Examples</a></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {currentYear} FabricAI. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
